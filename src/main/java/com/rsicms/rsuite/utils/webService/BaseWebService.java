 ...
 */
public abstract class BaseWebService extends DefaultRemoteApiHandler
    implements WebServiceUtilsConstants {
   ...
   * that incorporates the success* parameters, and when it doesn't want to refresh any objects in
   * the CMS UI.
   * 
   * @param context
   * @param user
  ...
  protected RemoteApiResult getWebServiceResponse(ExecutionContext context, User user,
    ...
    return getWebServiceResponse(context, user, opResult, new ArrayList<String>(), false, null,
        null);
  ...
  protected RestResult getInfoResult(ExecutionContext context, User user, String msg,
    ...
    RestResult webServiceResult =
        getNotificationResult(context, successMessage, getWebServiceLabel());
  ...
  protected static RestResult getNotificationResult(ExecutionContext context, String message,
    ...
    notification.addProperty(NotificationAction.PROPERTY_DURATION,
